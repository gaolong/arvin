...
#This is the ARVIN scripts directory
...
echo "..."
perl $arvin_scripts_dir/process_funseq_output.pl $input_snps_file $funseq_features_file $output_dir/features_funseq.csv
