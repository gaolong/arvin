...
preprocessing_scripts_dir=$arvin_software_dir/preprocessing/
...
echo "Processing CSI-ANN and IM-PET outputs"
echo "..."
...
perl $preprocessing_scripts_dir/combine_enhancer_and_ep_scores.pl $csi_ann_output_file $im_pet_output_file $gene_symbol_mapping_file $combined_score_file 
...
perl $preprocessing_scripts_dir/overlap_snps_with_ep.pl $input_snps_file $combined_score_file $snp_gene_file
...
echo "..."
perl $preprocessing_scripts_dir/process_funseq_output.pl $input_snps_file $funseq_features_file $output_dir/features_funseq.csv
perl $preprocessing_scripts_dir/merge_gwava_and_funseq_features.pl $gwava_features_file $output_dir/features_funseq.csv $output_dir/features_gwava_funseq.csv
...
perl $preprocessing_scripts_dir/disruption_snp_get_surrounding_regions.pl $input_snps_file $genome_dir $snp_seq_file
...
perl $preprocessing_scripts_dir/disruption_calculate_log_odds_ratio.pl $TFM_cutoff_file $pwm_dir $snp_seq_file $TFBS_score_dir $TFBS_score_changes_file
...
Rscript preprocessing/calculate_empirical_p_values.R $TFBS_score_changes_file $arvin_annotation_data_dir/score_changes_sampling/ $disruption_dir/disruption_p.txt
#R -q -e "ARVIN:::get_disruption_p_value('$TFBS_score_changes_file', '$arvin_annotation_data_dir/score_changes_sampling/', '$disruption_dir/disruption_p.txt')"
